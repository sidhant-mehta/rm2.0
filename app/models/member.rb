class Member < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me, :fname, :lname, :dob, :unconfirmed_email, :gender, :telephone, :location, :academic_institution, :course, :sector_ids, :employment_status, :hear_about_us
