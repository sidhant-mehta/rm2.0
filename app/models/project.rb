...
class Project < ActiveRecord::Base
  ...
  def organisation_check 
    ...
    def self.search (name, sector, location, closing_date, salary)
     ...
     validates_length_of :description, :minimum => 3, :maximum => 5000, :message => "You must include a description/bio for the mentor of between 3 to 5000 characters"
